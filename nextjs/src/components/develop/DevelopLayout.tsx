...
import {
  ...
  TerminalPanel,
  RightPanel,
} from "@/components/develop/transforms";
import { formatFile } from "@/components/develop/workspace/CodeEditor";
import AgentPanel from "@/components/develop/agent/AgentPanel";
import SourceControlPanel from "@/components/develop/workspace/SourceControlPanel";
import CommitHistory from "@/components/develop/workspace/CommitHistory";
import { GitCredentialDialog } from "@/components/develop/git";
import { DeleteProjectDialog } from "@/components/develop/transforms/DeleteProjectDialog";
import { HardDeleteProjectDialog } from "@/components/develop/transforms/HardDeleteProjectDialog";
import { RestoreProjectDialog } from "@/components/develop/transforms/RestoreProjectDialog";
...
import ProjectSettingsDialog from "@/components/develop/settings/ProjectSettingsDialog";
import type { DbtEnvironmentVariable, ProjectSettingsTab } from "@/components/develop/settings/types";
import { DEFAULT_DBT_TARGET } from "@/components/develop/settings/types";
